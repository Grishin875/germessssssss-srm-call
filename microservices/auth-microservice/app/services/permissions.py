...
ALLOWED_ROLES = ["user", "manager", "admin", "operator_smd", "montažnik", "operator_3d", "operator_engraving", "operator_otk", "operator_shipment", "warehouse"]
...
# Права по умолчанию для производственных ролей
