...
from app.models.shareholder import IntegrationNomenclatureMapping, IntegrationOrder  # noqa
...
app = FastAPI(title="Integration Service (1C/Bitrix)", lifespan=lifespan)
...
# Публичные пути (webhook'и не требуют JWT — они верифицируются по HMAC)
PUBLIC_PREFIXES = ("/api/integration/onec/", "/api/integration/bitrix/")
